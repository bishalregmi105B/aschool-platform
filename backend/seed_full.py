...
# NOTE (audit E6): plugin manifests (app/plugins/manifests/*.yaml) are the source of truth for pricing/tier — this hardcoded list drifts from them; seed.py syncs Plugin rows from manifests.
ALL_PLUGINS = [
    # ═══════════ FREE (core) ═══════════
    ...
    {"slug": "basic_website", "name": "School Website (Basic)", "name_nepali": "विद्यालय वेबसाइट (आधारभूत)", "category": "core", "price_monthly": 0, "price_yearly": 0, "is_free": True, "emoji": "🌐", "icon": "Globe", "description": "{slug}.aschool.com.np — free themes, about, contact, gallery", "sort_order": 4},
    ...
    {"slug": "website_builder", "name": "Website Builder (Pro)", "name_nepali": "वेबसाइट बिल्डर (प्रो)", "category": "growth", "price_monthly": 499, "price_yearly": 4999, "is_free": False, "trial_days": 14, "emoji": "🌐", "icon": "PaintBrush", "description": "10 open-source school themes + custom domain + AI builder + Craft.js editor", "sort_order": 24},
