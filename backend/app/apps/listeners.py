...
from app.apps.events import on
...
def _award_points_if_enabled(
    ...
    from app.apps.events import _school_has_plugin
...
def on_admission_accepted(school_id: str, application_id: str, **kwargs):
    ...
    try:
        ...
        from app.models.user import User
        from app.models.student import Student
        from app.apps.entitlements import StudentCapExceededError, assert_student_cap
