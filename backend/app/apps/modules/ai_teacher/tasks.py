...
def reconcile_lessons() -> dict:
    ...
    for lesson in stuck:
        ...
        final = None
        try:
            from app.apps.modules.ai_teacher.service_client import (
        ...
        if final:
            ...
            from app.apps.modules.ai_teacher.routes import apply_event
            ...
            if usage and lesson.cost_source != "measured":
                from app.apps.modules.ai_teacher.routes import _usage_log
