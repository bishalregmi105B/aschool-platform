...
def _character_certificate():
    ...
    return _canvas([
        ...
        _text(50, 270, W - 100, "_________________________________", 18, bold=True, color="#1e293b"),
        _text(50, 310, W - 100, "S/D/O:  _______________________    Class: ______", 13, color="#334155"),
        _text(50, 345, W - 100, "Enrollment No.: _________________", 13, color="#334155"),
        ...
        _text(65, 620, 200, "Date: ________________", 12, color="#334155", align="left"),
...
def _transfer_certificate():
    ...
    return _canvas([
        ...
        _text(50, 220, W - 100, "Certificate No.: ________", 11, color="#64748b"),
        _text(50, 255, W - 100, "1.  Name of Student     :  __________________________________", 12, color="#334155", align="left"),
        _text(50, 285, W - 100, "2.  Father's Name       :  __________________________________", 12, color="#334155", align="left"),
        _text(50, 315, W - 100, "3.  Mother's Name       :  __________________________________", 12, color="#334155", align="left"),
        _text(50, 345, W - 100, "4.  Date of Admission  :  __________________________________", 12, color="#334155", align="left"),
        _text(50, 375, W - 100, "5.  Date of Birth        :  ________________  (in words: ________________)", 12, color="#334155", align="left"),
        _text(50, 405, W - 100, "6.  Class last studied   :  ______  Section: ______", 12, color="#334155", align="left"),
        _text(50, 435, W - 100, "7.  Reason for leaving  :  __________________________________", 12, color="#334155", align="left"),
        _text(50, 465, W - 100, "8.  Date of leaving      :  __________________________________", 12, color="#334155", align="left"),
        _text(50, 495, W - 100, "9.  Conduct & Character  :  _________________________________", 12, color="#334155", align="left"),
        _text(50, 600, W - 100, "Certified that the above entries are taken from school records.", 12, italic=True, color="#475569"),
        _text(65, 700, 200, "Date: ________________", 12, color="#334155", align="left"),
...
def _merit_certificate():
    ...
    return _canvas([
        ...
        _text(60, 220, W - 120, "___________________________________________", 26, bold=True, color="#1e293b"),
        _text(60, 268, W - 120, "of Class: ___  Section: ___  Roll No: ___", 14, color="#44403c"),
        _text(60, 320, W - 120, "In recognition of outstanding achievement in", 14, color="#78350f"),
        _text(60, 356, W - 120, "___________________________________________", 18, bold=True, color="#92400e"),
        _text(60, 400, W - 120, "Ranked  ___  in  ___________________", 14, color="#44403c"),
        _text(60, 434, W - 120, "We congratulate and wish continued success in all future endeavours.", 13, italic=True, color="#57534e"),
        _text(160, 640, 200, "Date: ________", 12, color="#334155", align="left"),
...
def _participation_certificate():
    ...
    return _canvas([
        ...
        _text(60, 218, W - 120, "___________________________________________", 26, bold=True, color="#1e293b"),
        _text(60, 265, W - 120, "Class: ___  Section: ___  Roll No: ___", 14, color="#15803d"),
        _text(60, 310, W - 120, "has participated in the", 14, color="#166534"),
        _text(60, 344, W - 120, "___________________________________________", 18, bold=True, color="#14532d"),
        _text(60, 390, W - 120, "held on  _______________  at  _______________", 14, color="#166534"),
...
def _admit_card_standard():
    ...
    return _canvas([
        ...
        _text(30, 87, W - 60, "ADMIT CARD — EXAMINATION 2025", 13, bold=True, color="#1e40af"),
        ...
        _text(142, 124, W - 272, "______________________________", 10, color="#334155", align="left"),
        _text(30, 148, 50, "Class:", 10, bold=True, color="#0f172a", align="left"),
        _text(84, 148, 120, "________", 10, color="#334155", align="left"),
        _text(220, 148, 62, "Roll No.:", 10, bold=True, color="#0f172a", align="left"),
        _text(286, 148, 80, "________", 10, color="#334155", align="left"),
        _text(30, 172, 50, "DOB:", 10, bold=True, color="#0f172a", align="left"),
        _text(68, 172, 160, "________________", 10, color="#334155", align="left"),
...
def _report_card():
    ...
    return _canvas([
        ...
        _text(24, 107, 240, "Student: __________________", 10, color="#1e293b", align="left"),
        _text(280, 107, 120, "Class: ___  Sec: ___", 10, color="#1e293b", align="left"),
        _text(420, 107, 120, "Roll No: ______", 10, color="#1e293b", align="left"),
        _text(560, 107, 200, "Year: ________", 10, color="#1e293b", align="left"),
...
def _marksheet():
    ...
    return _canvas([
        ...
        _text(24, 118, 220, "Student Name: _______________", 10, color="#1e293b", align="left"),
        _text(24, 136, 220, "Father's Name: ______________", 10, color="#1e293b", align="left"),
        _text(24, 154, 220, "Mother's Name: ______________", 10, color="#1e293b", align="left"),
        _text(260, 118, 220, "Enrollment No.: _____________", 10, color="#1e293b", align="left"),
        _text(260, 136, 220, "Date of Birth: ______________", 10, color="#1e293b", align="left"),
        _text(260, 154, 220, "Class: _____  Section: ______", 10, color="#1e293b", align="left"),
        _text(500, 118, 270, "Exam: ______________________", 10, color="#1e293b", align="left"),
        _text(500, 136, 270, "Year: _______________________", 10, color="#1e293b", align="left"),
