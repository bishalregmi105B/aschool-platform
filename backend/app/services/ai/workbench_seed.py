...
TOOLS = [
    ...
    },
    {
        ...
        "trigger_phrases": [
            'build a blueprint', 'question paper blueprint', 'marks distribution',
            'ब्लुप्रिन्ट बनाउनुहोस्', 'प्रश्नपत्र योजना',
        ],
        "name": "Blueprint Builder",
        "name_ne": "ब्लुप्रिन्ट निर्माण",
        "category": "assessment",
        "description": "Marks × unit × difficulty grid for a question paper before generating it.",
        "min_plan_tier": "ai_suite",
        "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "blueprint_builder",
        "handler_name": "handle_blueprint_builder",
        "context_builder": "curriculum",
        "status": "ga",
        "nutrition": {
            "model_name": "llama-3.3-70b (Groq) / Claude fallback",
            ...
            "data_accessed": ["curriculum units"],
            "data_not_accessed": ["student records", "marks", "behaviour"],
            "limitations": "Section totals are recomputed server-side; the grid is a draft until the teacher approves it.",
        },
    },
    {
        "tool_key": "text_leveler",
        "ui_type": 'form',
        "budget": 'tier2',
        "icon": '🎚️',
        "grounding": 'none',
        ...
        "output_document_type": 'none',
        "trigger_phrases": [
            'simplify this text', 'rewrite easier', 'raise reading level',
            'पाठ सजिलो बनाउनुहोस्', 'पाठ स्तर परिवर्तन',
        ],
        "name": "Text Leveler",
        "name_ne": "पाठ स्तर परिवर्तन",
        "category": "differentiation",
        "description": "Rewrite any passage up or down ~3 grade levels with a change log.",
        "min_plan_tier": "ai_suite",
        "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "text_leveler",
        "handler_name": "handle_text_leveler",
        ...
        "nutrition": {
            ...
            "data_accessed": [],
            "data_not_accessed": ["student records", "marks", "behaviour"],
            "limitations": "Fact-bearing text must be re-checked after leveling.",
        },
    },
    {
        "tool_key": "vocab_support",
        "ui_type": 'form',
        "budget": 'tier1',
        "icon": '📚',
        "grounding": 'optional',
        ...
        "output_document_type": 'none',
        "trigger_phrases": [
            'vocabulary list', 'word bank', 'key terms',
            'शब्दावली सूची', 'मुख्य शब्द',
        ],
        "name": "Vocabulary Builder",
        "name_ne": "शब्दावली",
        "category": "differentiation",
        "description": "Bilingual (EN/NE) term banks with definitions and examples.",
        "min_plan_tier": "free",
        "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "vocab_support",
        "handler_name": "handle_vocab_support",
        "context_builder": "curriculum",
        "status": "ga",
        "nutrition": {
            "model_name": "llama-3.3-70b (Groq) / Claude fallback",
            ...
            "limitations": "Nepali renderings should be checked by a language teacher.",
        },
    },
    {
        "tool_key": "lesson_hook",
        "ui_type": 'form',
        "budget": 'tier1',
        "icon": '🪝',
        "grounding": 'optional',
        ...
        "output_document_type": 'none',
        "trigger_phrases": [
            'lesson hook', 'engaging opener', 'warm up activity',
            'कक्षा सुरुवात गतिविधि', 'पाठ हुक',
        ],
        "name": "Lesson Hook",
        "name_ne": "पाठ हुक",
        "category": "planning",
        "description": "5-minute openers that make a topic impossible to ignore.",
        "min_plan_tier": "free",
        "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "lesson_hook",
        "handler_name": "handle_generic_count",
        "context_builder": "curriculum",
        "status": "ga",
        "nutrition": {
            "model_name": "llama-3.3-70b (Groq) / Claude fallback",
            ...
            "data_accessed": ["curriculum units"],
            "data_not_accessed": ["student records", "marks"],
            "limitations": "Check materials against what the class actually has.",
        },
    },
    {
        "tool_key": "email_responder",
        "ui_type": 'form',
        "budget": 'tier1',
        "icon": '✉️',
        "grounding": 'none',
        ...
        "output_document_type": 'none',
        "trigger_phrases": [
            'reply to parent', 'draft email', 'respond to complaint',
            'इमेल जवाफ लेख्नुहोस्', 'पत्र जवाफ',
        ],
        "name": "Email Responder",
        "name_ne": "इमेल जवाफ",
        "category": "communication",
        "description": "Professional parent/stakeholder email replies from your bullet points.",
        "min_plan_tier": "ai_suite",
        "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "email_responder",
        "handler_name": "handle_generic_count",
        "context_builder": "none",
        "status": "ga",
        "nutrition": {
            ...
            "data_accessed": [],
            "data_not_accessed": ["student records", "marks"],
            "limitations": "Review names and commitments before sending.",
        },
    },
    {
        "tool_key": "meeting_minutes",
        "ui_type": 'form',
        "budget": 'tier2',
        "icon": '🗒️',
        "grounding": 'none',
        ...
        "output_document_type": 'none',
        "trigger_phrases": [
            'meeting minutes', 'action items from notes', 'staff meeting summary',
            'मिटिङ मिनेट', 'कार्यविश्लेषण',
        ],
        "name": "Meeting Minutes",
        "name_ne": "मिटिङ मिनेट",
        "category": "admin",
        "description": "Raw staff-meeting notes → structured minutes with decisions and action items.",
        "min_plan_tier": "ai_suite",
        "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "meeting_minutes",
        "handler_name": "handle_generic_count",
        "context_builder": "none",
        "status": "ga",
        "nutrition": {
            ...
            "data_accessed": [],
            "data_not_accessed": ["student records"],
            "limitations": "Confirm owners and due dates with attendees.",
        },
    },
    # ── Differentiation pack (wave-2) ─────────────────────────────────────
    {
        "tool_key": "text_scaffolder",
        "ui_type": 'form', "budget": 'tier2', "icon": '🪜', "grounding": 'none',
        "sort_order": 10, "output_document_type": 'none',
        "trigger_phrases": ['scaffold this writing', 'step by step support', 'सहयोगी चरण बनाउनुहोस्'],
        "name": "Writing Scaffold", "name_ne": "लेखन सहायता",
        "category": "differentiation",
        "description": "Step-by-step writing support with sentence starters for struggling writers.",
        "min_plan_tier": "ai_suite", "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "text_scaffolder", "handler_name": "handle_generic_count",
        "context_builder": "none", "status": "ga",
        "nutrition": {
            "model_name": "llama-3.3-70b (Groq) / Claude fallback", "provider": "groq",
            "data_accessed": [], "data_not_accessed": ["student records", "marks"],
            "limitations": "Adapt starters to the class level before printing.",
        },
    },
    {
        "tool_key": "accommodation_finder",
        "ui_type": 'form', "budget": 'tier2', "icon": '♿', "grounding": 'none',
        "sort_order": 11, "output_document_type": 'none',
        "trigger_phrases": ['classroom accommodation', 'support for struggling student', 'कक्षा समायोजन'],
        "name": "Accommodation Finder", "name_ne": "कक्षा समायोजन",
        "category": "differentiation",
        "description": "Barrier → accommodation suggestions across presentation, response and setting.",
        "min_plan_tier": "ai_suite", "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "accommodation_finder", "handler_name": "handle_generic_count",
        "context_builder": "none", "status": "ga",
        "nutrition": {
            "model_name": "llama-3.3-70b (Groq) / Claude fallback", "provider": "groq",
            "data_accessed": [], "data_not_accessed": ["student records", "health", "behaviour"],
            "limitations": "Not a diagnosis or an IEP substitute — involve the SEN coordinator.",
        },
    },
    {
        "tool_key": "enrichment_plan",
        "ui_type": 'form', "budget": 'tier2', "icon": '🚀', "grounding": 'optional',
        "sort_order": 12, "output_document_type": 'none',
        "trigger_phrases": ['enrichment activities', 'advanced students project', 'थप गतिविधि'],
        "name": "Enrichment Planner", "name_ne": "सम्वर्धन योजना",
        "category": "differentiation",
        "description": "Stretch activities for early finishers and advanced learners.",
        "min_plan_tier": "ai_suite", "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "enrichment_plan", "handler_name": "handle_generic_count",
        "context_builder": "curriculum", "status": "ga",
        "nutrition": {
            "model_name": "llama-3.3-70b (Groq) / Claude fallback", "provider": "groq",
            "data_accessed": ["curriculum units"], "data_not_accessed": ["student records", "marks"],
            "limitations": "Difficulty labels are estimates.",
        },
    },
    {
        "tool_key": "udl_choice_board",
        "ui_type": 'form', "budget": 'tier2', "icon": '🎯', "grounding": 'optional',
        "sort_order": 13, "output_document_type": 'none',
        "trigger_phrases": ['choice board', 'udl board', 'छनोट बोर्ड'],
        "name": "UDL Choice Board", "name_ne": "छनोट बोर्ड",
        "category": "differentiation",
        "description": "3×3 choice boards balancing UDL: show, express, engage.",
        "min_plan_tier": "ai_suite", "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "udl_choice_board", "handler_name": "handle_udl_board",
        "context_builder": "curriculum", "status": "ga",
        "nutrition": {
            "model_name": "llama-3.3-70b (Groq) / Claude fallback", "provider": "groq",
            "data_accessed": ["curriculum units"], "data_not_accessed": ["student records"],
            "limitations": "Swap tasks for local materials as needed.",
        },
    },
    # ── Comms + PD pack (wave-2) ──────────────────────────────────────────
    {
        "tool_key": "attendance_outreach",
        "ui_type": 'form', "budget": 'tier2', "icon": '📣', "grounding": 'required',
        "sort_order": 14, "output_document_type": 'none',
        "trigger_phrases": ['absence note', 'attendance outreach', 'अनुपस्थिति सम्पर्क'],
        "name": "Attendance Outreach", "name_ne": "उपस्थिति सम्पर्क",
        "category": "communication",
        "description": "Kind, escalating absence-follow-up messages for guardians.",
        "min_plan_tier": "ai_suite", "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "attendance_outreach", "handler_name": "handle_generic_count",
        "context_builder": "attendance", "status": "ga",
        "nutrition": {
            "model_name": "llama-3.3-70b (Groq) / Claude fallback", "provider": "groq",
            "data_accessed": ["attendance summary counts"], "data_not_accessed": ["marks", "health", "behaviour"],
            "limitations": "Messages are drafts; a human sends them.",
        },
    },
    {
        "tool_key": "progress_conference",
        "ui_type": 'form', "budget": 'tier2', "icon": '🤝', "grounding": 'optional',
        "sort_order": 15, "output_document_type": 'none',
        "trigger_phrases": ['parent teacher meeting prep', 'conference agenda', 'अभिभावक भेट तयारी'],
        "name": "Conference Prep", "name_ne": "अभिभावक भेट तयारी",
        "category": "communication",
        "description": "PT conference agendas with talking points and open questions.",
        "min_plan_tier": "ai_suite", "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "progress_conference", "handler_name": "handle_generic_count",
        "context_builder": "none", "status": "ga",
        "nutrition": {
            "model_name": "llama-3.3-70b (Groq) / Claude fallback", "provider": "groq",
            "data_accessed": [], "data_not_accessed": ["health", "behaviour"],
            "limitations": "Bring real marks/attendance data to the meeting, not AI summaries.",
        },
    },
    {
        "tool_key": "lesson_observation",
        "ui_type": 'form', "budget": 'tier2', "icon": '🔍', "grounding": 'none',
        "sort_order": 16, "output_document_type": 'none',
        "trigger_phrases": ['lesson observation notes', 'peer observation feedback', 'कक्षा अवलोकन'],
        "name": "Observation Feedback", "name_ne": "कक्षा अवलोकन प्रतिक्रिया",
        "category": "pd",
        "description": "Turn raw observation notes into balanced strengths/growth feedback.",
        "min_plan_tier": "ai_suite", "roles_allowed": ["school_admin"],
        "output_schema_name": "lesson_observation", "handler_name": "handle_generic_count",
        "context_builder": "none", "status": "ga",
        "nutrition": {
            "model_name": "llama-3.3-70b (Groq) / Claude fallback", "provider": "groq",
            "data_accessed": [], "data_not_accessed": ["student records", "marks"],
            "limitations": "Feedback is a draft for the observer to own.",
        },
    },
    {
