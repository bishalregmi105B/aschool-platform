...
TOOLS = [
    ...
    {
        "tool_key": "annual_scheme",
        "ui_type": 'form', "budget": 'tier2', "icon": '🗓️', "grounding": 'required',
        "sort_order": 17, "output_document_type": 'none',
        "trigger_phrases": ['annual scheme', 'yearly plan', 'वार्षिक योजना'],
        "name": "Annual Scheme", "name_ne": "वार्षिक योजना",
        "category": "planning",
        "description": "Month-by-month syllabus distribution over the Nepali academic year.",
        "min_plan_tier": "ai_suite", "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "annual_scheme", "handler_name": "handle_generic_count",
        "context_builder": "curriculum", "status": "ga",
        "nutrition": {
            "model_name": "llama-3.3-70b (Groq) / Claude fallback", "provider": "groq",
            "data_accessed": ["curriculum units"], "data_not_accessed": ["student records"],
            "limitations": "Balance against your school calendar and holidays.",
        },
    },
    {
        "tool_key": "transition_guide",
        "ui_type": 'form', "budget": 'tier2', "icon": '🧭', "grounding": 'none',
        "sort_order": 18, "output_document_type": 'none',
        "trigger_phrases": ['transition guide', 'next grade preparation', 'कक्षा सार्ने तयारी'],
        "name": "Transition Guide", "name_ne": "संक्रमण गाइड",
        "category": "pd",
        "description": "Grade-transition guides (e.g. 10→11) for students and guardians.",
        "min_plan_tier": "ai_suite", "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "transition_guide", "handler_name": "handle_generic_count",
        "context_builder": "none", "status": "ga",
        "nutrition": {
            "model_name": "llama-3.3-70b (Groq) / Claude fallback", "provider": "groq",
            "data_accessed": [], "data_not_accessed": ["student records"],
            "limitations": "Verify against current NEB stream requirements.",
        },
    },
    {
        "tool_key": "exam_timetable",
        "ui_type": 'form', "budget": 'tier1', "icon": '📅', "grounding": 'none',
        "sort_order": 19, "output_document_type": 'none',
        "trigger_phrases": ['exam schedule draft', 'exam timetable', 'परीक्षा तालिका'],
        "name": "Exam Timetable Drafter", "name_ne": "परीक्षा तालिका",
        "category": "assessment",
        "description": "Draft exam-day schedules with gap and subject-clash checks.",
        "min_plan_tier": "ai_suite", "roles_allowed": ["school_admin"],
        "output_schema_name": "exam_timetable", "handler_name": "handle_generic_count",
        "context_builder": "none", "status": "ga",
        "nutrition": {
            "model_name": "llama-3.3-70b (Groq) / Claude fallback", "provider": "groq",
            "data_accessed": [], "data_not_accessed": ["student records"],
            "limitations": "A draft — the constraint solver owns the final timetable.",
        },
    },
    {
        "tool_key": "practical_exam",
        "ui_type": 'form', "budget": 'tier1', "icon": '🔬', "grounding": 'optional',
        "sort_order": 20, "output_document_type": 'none',
        "trigger_phrases": ['practical exam', 'lab assessment', 'प्रयोगात्मक परीक्षा'],
        "name": "Practical Exam Builder", "name_ne": "प्रयोगात्मक परीक्षा",
        "category": "assessment",
        "description": "Lab/practical assessments with tasks, materials and marking criteria.",
        "min_plan_tier": "ai_suite", "roles_allowed": ["teacher", "school_admin"],
        "output_schema_name": "practical_exam", "handler_name": "handle_practical_exam",
        "context_builder": "curriculum", "status": "ga",
        "nutrition": {
            "model_name": "llama-3.3-70b (Groq) / Claude fallback", "provider": "groq",
            "data_accessed": ["curriculum units"], "data_not_accessed": ["student records"],
            "limitations": "Check materials against your lab inventory.",
        },
    },
    {
