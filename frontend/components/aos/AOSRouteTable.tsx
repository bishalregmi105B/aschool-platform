...
export const AOS_ROUTE_COMPONENTS: Record<string, React.ComponentType<any>> = {
  ...
  "files": dynamic(() => import("./apps/FileManagerApp"), { loading: AOSModuleLoading }), // /dashboard/files → AOS File Manager
  ...
  "transport__prefs": dynamic(() => import("@/app/dashboard/transport/prefs/page"), { loading: AOSModuleLoading }), // /dashboard/transport/prefs (wave-E: geofence alert radius)
  ...
  "library__acquisition": dynamic(() => import("@/app/dashboard/library/acquisition/page"), { loading: AOSModuleLoading }), // /dashboard/library/acquisition (wave-E: POs + vendors)
