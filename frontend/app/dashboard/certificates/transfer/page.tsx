  ...
  return (
    <AOSPage>
      <AOSPageHeader
        ...
        subtitle="Generate official School Leaving / Transfer Certificates"
      />
      <AOSPageBody>
        <div className="grid md:grid-cols-3 gap-4">
        <DataPanel className="md:col-span-1 h-fit" title="Search Student">
          <div className="space-y-4">
            <p className="text-sm" style={{ color: "var(--w11-text-secondary)" }}>Find a student who is leaving the school</p>
                  ...
                  return (
                    <div className="space-y-6">
                      ...
                      >
                        ...
                        <div>
                          <Label className="text-xs" style={{ color: "var(--w11-text-secondary)" }}>Current Class</Label>
                          <div className="font-medium" style={{ color: "var(--w11-text-primary)" }}>{student.fields.class || "—"}</div>
                        </div>
                        <div>
                      ...
                      <div className="space-y-4 pt-4 border-t border-[var(--w11-border-subtle)]">
                        <h3 className="font-medium" style={{ color: "var(--w11-text-primary)" }}>Leaving Details</h3>
